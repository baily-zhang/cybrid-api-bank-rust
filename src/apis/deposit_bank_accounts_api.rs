...
/// struct for typed errors of method [`create_deposit_bank_account`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateDepositBankAccountError {
...
/// struct for typed errors of method [`get_deposit_bank_account`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetDepositBankAccountError {
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
...
/// struct for typed errors of method [`list_deposit_bank_accounts`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListDepositBankAccountsError {
...
pub async fn create_deposit_bank_account(configuration: &configuration::Configuration, post_deposit_bank_account: models::PostDepositBankAccount) -> Result<models::DepositBankAccount, Error<CreateDepositBankAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_post_deposit_bank_account = post_deposit_bank_account;

    let uri_str = format!("{}/api/deposit_bank_accounts", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_body_post_deposit_bank_account);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DepositBankAccount`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DepositBankAccount`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateDepositBankAccountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Retrieves a deposit bank account.  Required scope: **deposit_bank_accounts:read**
pub async fn get_deposit_bank_account(configuration: &configuration::Configuration, deposit_bank_account_guid: &str) -> Result<models::DepositBankAccount, Error<GetDepositBankAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_deposit_bank_account_guid = deposit_bank_account_guid;

    let uri_str = format!("{}/api/deposit_bank_accounts/{deposit_bank_account_guid}", configuration.base_path, deposit_bank_account_guid=crate::apis::urlencode(p_path_deposit_bank_account_guid));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetDepositBankAccountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn list_deposit_bank_accounts(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>, guid: Option<&str>, bank_guid: Option<&str>, customer_guid: Option<&str>, label: Option<&str>, unique_memo_id: Option<&str>, r#type: Option<&str>, parent_deposit_bank_account_guid: Option<&str>) -> Result<models::DepositBankAccountList, Error<ListDepositBankAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    let p_query_unique_memo_id = unique_memo_id;
    let p_query_type = r#type;
    let p_query_parent_deposit_bank_account_guid = parent_deposit_bank_account_guid;
    ...
    if let Some(ref param_value) = p_query_unique_memo_id {
        req_builder = req_builder.query(&[("unique_memo_id", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_type {
        req_builder = req_builder.query(&[("type", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_parent_deposit_bank_account_guid {
        req_builder = req_builder.query(&[("parent_deposit_bank_account_guid", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::DepositBankAccountList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::DepositBankAccountList`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListDepositBankAccountsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
