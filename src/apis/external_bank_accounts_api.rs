...
/// struct for typed errors of method [`create_external_bank_account`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateExternalBankAccountError {
...
/// struct for typed errors of method [`delete_external_bank_account`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteExternalBankAccountError {
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
...
/// struct for typed errors of method [`get_external_bank_account`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetExternalBankAccountError {
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
    Status422(models::ErrorResponse),
...
/// struct for typed errors of method [`list_external_bank_accounts`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListExternalBankAccountsError {
    Status400(models::ErrorResponse),
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    UnknownValue(serde_json::Value),
...
/// struct for typed errors of method [`patch_external_bank_account`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PatchExternalBankAccountError {
    Status401(models::ErrorResponse),
    Status403(models::ErrorResponse),
    Status404(models::ErrorResponse),
    UnknownValue(serde_json::Value),
...
pub async fn create_external_bank_account(configuration: &configuration::Configuration, post_external_bank_account: models::PostExternalBankAccount) -> Result<models::ExternalBankAccount, Error<CreateExternalBankAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_post_external_bank_account = post_external_bank_account;

    let uri_str = format!("{}/api/external_bank_accounts", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_body_post_external_bank_account);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ExternalBankAccount`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ExternalBankAccount`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<CreateExternalBankAccountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Deletes an external bank account.  Required scope: **external_bank_accounts:execute**
pub async fn delete_external_bank_account(configuration: &configuration::Configuration, external_bank_account_guid: &str) -> Result<models::ExternalBankAccount, Error<DeleteExternalBankAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_external_bank_account_guid = external_bank_account_guid;

    let uri_str = format!("{}/api/external_bank_accounts/{external_bank_account_guid}", configuration.base_path, external_bank_account_guid=crate::apis::urlencode(p_path_external_bank_account_guid));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<DeleteExternalBankAccountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_external_bank_account(configuration: &configuration::Configuration, external_bank_account_guid: &str, force_balance_refresh: Option<bool>, include_balances: Option<bool>, include_pii: Option<bool>) -> Result<models::ExternalBankAccount, Error<GetExternalBankAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_external_bank_account_guid = external_bank_account_guid;
    let p_query_force_balance_refresh = force_balance_refresh;
    let p_query_include_balances = include_balances;
    let p_query_include_pii = include_pii;

    let uri_str = format!("{}/api/external_bank_accounts/{external_bank_account_guid}", configuration.base_path, external_bank_account_guid=crate::apis::urlencode(p_path_external_bank_account_guid));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);

    if let Some(ref param_value) = p_query_force_balance_refresh {
        req_builder = req_builder.query(&[("force_balance_refresh", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_include_balances {
        req_builder = req_builder.query(&[("include_balances", &param_value.to_string())]);
    }
    if let Some(ref param_value) = p_query_include_pii {
        req_builder = req_builder.query(&[("include_pii", &param_value.to_string())]);
    }
    if let Some(ref user_agent) = configuration.user_agent {
        req_builder = req_builder.header(reqwest::header::USER_AGENT, user_agent.clone());
    }
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetExternalBankAccountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn list_external_bank_accounts(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>, guid: Option<&str>, bank_guid: Option<&str>, customer_guid: Option<&str>, counterparty_guid: Option<&str>, asset: Option<&str>, state: Option<&str>) -> Result<models::ExternalBankAccountList, Error<ListExternalBankAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::ExternalBankAccountList`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::ExternalBankAccountList`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<ListExternalBankAccountsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Patch an external bank account.  Required scope: **external_bank_accounts:write**
pub async fn patch_external_bank_account(configuration: &configuration::Configuration, external_bank_account_guid: &str, patch_external_bank_account: models::PatchExternalBankAccount) -> Result<models::ExternalBankAccount, Error<PatchExternalBankAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_external_bank_account_guid = external_bank_account_guid;
    let p_body_patch_external_bank_account = patch_external_bank_account;
    ...
    req_builder = req_builder.json(&p_body_patch_external_bank_account);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<PatchExternalBankAccountError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
