...
pub async fn create_account(configuration: &configuration::Configuration, post_account: models::PostAccount) -> Result<models::Account, Error<CreateAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_post_account = post_account;
    ...
    req_builder = req_builder.json(&p_body_post_account);
...
pub async fn get_account(configuration: &configuration::Configuration, account_guid: &str) -> Result<models::Account, Error<GetAccountError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_account_guid = account_guid;

    let uri_str = format!("{}/api/accounts/{account_guid}", configuration.base_path, account_guid=crate::apis::urlencode(p_path_account_guid));
...
pub async fn list_accounts(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>, owner: Option<&str>, guid: Option<&str>, r#type: Option<&str>, bank_guid: Option<&str>, customer_guid: Option<&str>, label: Option<&str>) -> Result<models::AccountList, Error<ListAccountsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
