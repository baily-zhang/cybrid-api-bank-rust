...
/// PostIdentityVerification : Request body for identity verification creation.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostIdentityVerification {
    ...
    #[serde(rename = "customer_guid", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub customer_guid: Option<Option<String>>,
    /// The optional expected behaviour to simulate.
    #[serde(rename = "expected_behaviours", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub expected_behaviours: Option<Option<Vec<ExpectedBehaviours>>>,
    ...
    #[serde(rename = "counterparty_guid", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub counterparty_guid: Option<Option<String>>,
    ...
    #[serde(rename = "require_tax_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub require_tax_id: Option<Option<bool>>,
    #[serde(rename = "name", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub name: Option<Option<Box<models::PostIdentityVerificationName>>>,
    #[serde(rename = "address", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub address: Option<Option<Box<models::PostIdentityVerificationAddress>>>,
    ...
    #[serde(rename = "identification_numbers", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub identification_numbers: Option<Option<Vec<models::PostIdentificationNumber>>>,
    ...
    pub aliases: Option<Option<Vec<models::PostIdentityVerificationAliasesInner>>>,
    ...
    #[serde(rename = "nature_of_business", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub nature_of_business: Option<Option<String>>,
    ...
    #[serde(rename = "director_customer_guids", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub director_customer_guids: Option<Option<Vec<String>>>,
    ...
    #[serde(rename = "ultimate_beneficial_owners", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub ultimate_beneficial_owners: Option<Option<Vec<models::PostUltimateBeneficialOwner>>>,
    ...
    #[serde(rename = "supporting_file_guids", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub supporting_file_guids: Option<Option<Vec<String>>>,
    #[serde(rename = "registered_address", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub registered_address: Option<Option<Box<models::PostIdentityVerificationRegisteredAddress>>>,
    ...
    #[serde(rename = "business_industry", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub business_industry: Option<Option<String>>,
    ...
    #[serde(rename = "business_funds_source", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub business_funds_source: Option<Option<String>>,
    ...
    #[serde(rename = "business_funds_destination", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub business_funds_destination: Option<Option<String>>,
    ...
    #[serde(rename = "biometrics_verified", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub biometrics_verified: Option<Option<bool>>,
    /// The external bank account's identifier. Required when type is bank_account.
    #[serde(rename = "external_bank_account_guid", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub external_bank_account_guid: Option<Option<String>>,
}

impl PostIdentityVerification {
    /// Request body for identity verification creation.
    pub fn new(r#type: Type) -> PostIdentityVerification {
        PostIdentityVerification {
            r#type,
            customer_guid: None,
            expected_behaviours: None,
            method: None,
            ...
            director_customer_guids: None,
            ultimate_beneficial_owners: None,
            supporting_file_guids: None,
            registered_address: None,
            business_industry: None,
            business_funds_source: None,
            business_funds_destination: None,
            occupation: None,
            biometrics_verified: None,
            external_bank_account_guid: None,
        }
    }
}
/// The type of identity verification.
...
/// The optional expected behaviour to simulate.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum ExpectedBehaviours {
    #[serde(rename = "passed_immediately")]
    PassedImmediately,
    #[serde(rename = "failed_immediately")]
    FailedImmediately,
    #[serde(rename = "tax_id_not_checked")]
    TaxIdNotChecked,
}

impl Default for ExpectedBehaviours {
    fn default() -> ExpectedBehaviours {
        Self::PassedImmediately
    }
}
/// The identity verification method. Required when type is counterparty, type is kyc, or type is bank_account.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum Method {
    ...
    Attested,
    #[serde(rename = "document_submission")]
    DocumentSubmission,
    #[serde(rename = "enhanced_due_diligence")]
    EnhancedDueDiligence,
    #[serde(rename = "id_and_selfie")]
    IdAndSelfie,
    #[serde(rename = "tax_id_and_selfie")]
    TaxIdAndSelfie,
    #[serde(rename = "business_registration")]
    BusinessRegistration,
    #[serde(rename = "attested_id_and_selfie")]
    AttestedIdAndSelfie,
    #[serde(rename = "attested_business_registration")]
    AttestedBusinessRegistration,
    #[serde(rename = "attested_business_associate")]
    AttestedBusinessAssociate,
    #[serde(rename = "attested_id_and_database")]
    AttestedIdAndDatabase,
    #[serde(rename = "attested_ownership")]
    AttestedOwnership,
    #[serde(rename = "account_ownership")]
    AccountOwnership,
}
