...
/// PostPlan : Request body for plan creation.
...
pub struct PostPlan {
    ...
    pub source_account: Box<models::PostPlanSourceAccount>,
    #[serde(rename = "destination_account")]
    pub destination_account: Box<models::PostPlanDestinationAccount>,
    #[serde(rename = "travel_rule_info", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub travel_rule_info: Option<Option<Box<models::PostPlanTravelRuleInfo>>>,
...
impl PostPlan {
    ...
    pub fn new(r#type: Type, source_account: models::PostPlanSourceAccount, destination_account: models::PostPlanDestinationAccount) -> PostPlan {
        PostPlan {
            r#type,
            bank_guid: None,
            customer_guid: None,
