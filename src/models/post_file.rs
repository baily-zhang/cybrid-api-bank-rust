...
/// PostFile : Request body for a new file.
...
pub struct PostFile {
    ...
    pub metadata: Option<Option<Box<models::PostFileMetadata>>>,
}

impl PostFile {
    /// Request body for a new file.
    pub fn new(r#type: Type, customer_guid: String, filename: String, content_type: ContentType) -> PostFile {
        PostFile {
            r#type,
            customer_guid,
            filename,
...
pub enum Type {
    #[serde(rename = "drivers_license_front")]
    DriversLicenseFront,
    #[serde(rename = "drivers_license_back")]
    DriversLicenseBack,
    #[serde(rename = "drivers_license")]
    DriversLicense,
    #[serde(rename = "passport")]
    Passport,
    #[serde(rename = "passport_card")]
    PassportCard,
    #[serde(rename = "visa")]
    Visa,
    #[serde(rename = "identification_card")]
    IdentificationCard,
    #[serde(rename = "residence_card")]
    ResidenceCard,
    #[serde(rename = "work_permit")]
    WorkPermit,
    #[serde(rename = "indigenous_id_document")]
    IndigenousIdDocument,
    #[serde(rename = "selfie")]
    Selfie,
    #[serde(rename = "selfie_video")]
    SelfieVideo,
    #[serde(rename = "selfie_left")]
    SelfieLeft,
    #[serde(rename = "selfie_right")]
    SelfieRight,
    ...
    PropertyTax,
    #[serde(rename = "tax_document")]
    TaxDocument,
    #[serde(rename = "ein_letter")]
    EinLetter,
    #[serde(rename = "incorporation_certificate")]
    IncorporationCertificate,
    #[serde(rename = "persona_inquiry_report")]
    PersonaInquiryReport,
    #[serde(rename = "persona_inquiry_export")]
    PersonaInquiryExport,
}

impl Default for Type {
    fn default() -> Type {
        Self::DriversLicenseFront
    }
}
/// The content type of the file.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
