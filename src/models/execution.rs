...
pub struct Execution {
    ...
    pub travel_rule_info: Box<models::ExecutionTravelRuleInfo>,
...
impl Execution {
    pub fn new(guid: String, r#type: String, plan_guid: String, created_at: String, updated_at: String, state: String, source_account: models::AccountAssociation, destination_account: models::AccountAssociation, stages: Vec<models::Stage>, fees: Vec<models::FeeAssociation>, travel_rule_info: models::ExecutionTravelRuleInfo) -> Execution {
        Execution {
            guid,
            r#type,
            plan_guid,
