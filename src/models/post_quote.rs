...
/// PostQuote : Request body for quote creation.
...
pub struct PostQuote {
    ...
    pub product_type: Option<Option<ProductType>>,
    ...
    #[serde(rename = "receive_amount", skip_serializing_if = "Option::is_none")]
    pub receive_amount: Option<i32>,
    ...
    #[serde(rename = "deliver_amount", skip_serializing_if = "Option::is_none")]
    pub deliver_amount: Option<i32>,
    ...
    #[serde(rename = "asset", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub asset: Option<Option<String>>,
    /// The network address to pay the invoice to. Required when product_type is lightning_transfer.
    #[serde(rename = "network_address", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub network_address: Option<Option<String>>,
    ...
    pub fees: Option<Option<Vec<models::PostFee>>>,
    ...
    #[serde(rename = "destination_accounts", skip_serializing_if = "Option::is_none")]
    pub destination_accounts: Option<Vec<models::PostQuoteEntry>>,
    /// The guid of the related trade. Only present on `exit` trades. Required when product_type is trading_exit.
    #[serde(rename = "reference_trade_guid", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub reference_trade_guid: Option<Option<String>>,
...
impl PostQuote {
    ...
    pub fn new() -> PostQuote {
        PostQuote {
            ...
            symbol: None,
            destination_accounts: None,
            reference_trade_guid: None,
...
pub enum ProductType {
    ...
    Funding,
    #[serde(rename = "crypto_transfer")]
    CryptoTransfer,
    #[serde(rename = "inter_account")]
    InterAccount,
    #[serde(rename = "lightning_transfer")]
    LightningTransfer,
    #[serde(rename = "book_transfer")]
    BookTransfer,
}
