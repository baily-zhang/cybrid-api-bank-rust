...
/// PostBankAccountDetails : Bank account details.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct PostBankAccountDetails {
    /// The bank code.
    ...
    #[serde(rename = "account_identifier_type", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub account_identifier_type: Option<Option<AccountIdentifierType>>,
    /// The payment rail used for the account.
    #[serde(rename = "payment_rail")]
    ...
    #[serde(rename = "bank_code_type", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub bank_code_type: Option<Option<BankCodeType>>,
...
impl PostBankAccountDetails {
    /// Bank account details.
    pub fn new(account_identifier: String, payment_rail: PaymentRail) -> PostBankAccountDetails {
        PostBankAccountDetails {
            bank_code: None,
            account_identifier,
            account_identifier_type: None,
            payment_rail,
            bank_code_type: None,
            account_type: None,
        }
...
impl Default for AccountIdentifierType {
    fn default() -> AccountIdentifierType {
        Self::Clabe
    }
}
/// The payment rail used for the account.
...
pub enum PaymentRail {
    ...
    #[serde(rename = "LBTR")]
    Lbtr,
    #[serde(rename = "EASY_PAISA")]
    EasyPaisa,
    #[serde(rename = "FINJA")]
    Finja,
    #[serde(rename = "JAZZ_CASH")]
    JazzCash,
    #[serde(rename = "NAYA_PAY")]
    NayaPay,
    #[serde(rename = "SADA_PAY")]
    SadaPay,
...
impl Default for BankCodeType {
    fn default() -> BankCodeType {
        Self::Cpa
    }
}
/// The type of account. Required when payment_rail is PSE or payment_rail is LBTR.
