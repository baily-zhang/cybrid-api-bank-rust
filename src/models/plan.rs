...
pub struct Plan {
    ...
    pub source_account: Box<models::AccountAssociation>,
    #[serde(rename = "destination_account")]
    pub destination_account: Box<models::AccountAssociation>,
    /// The stages of the plan.
    #[serde(rename = "stages")]
    pub stages: Vec<models::Stage>,
    /// The fees associated with the plan.
    #[serde(rename = "fees")]
    pub fees: Vec<models::FeeAssociation>,
    #[serde(rename = "travel_rule_info")]
    pub travel_rule_info: Box<models::PlanTravelRuleInfo>,
    /// The purpose of transaction for the plan.
    #[serde(rename = "purpose_of_transaction", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub purpose_of_transaction: Option<Option<PurposeOfTransaction>>,
}

impl Plan {
    pub fn new(guid: String, r#type: String, created_at: String, updated_at: String, expires_at: String, state: String, source_account: models::AccountAssociation, destination_account: models::AccountAssociation, stages: Vec<models::Stage>, fees: Vec<models::FeeAssociation>, travel_rule_info: models::PlanTravelRuleInfo) -> Plan {
        Plan {
            guid,
            r#type,
            bank_guid: None,
            ...
            state,
            failure_code: None,
            source_account: Box::new(source_account),
            destination_account: Box::new(destination_account),
            stages,
            fees,
            travel_rule_info: Box::new(travel_rule_info),
...
pub enum PurposeOfTransaction {
    #[serde(rename = "computer_services")]
    ComputerServices,
    #[serde(rename = "family_support")]
    FamilySupport,
    #[serde(rename = "education")]
    Education,
    #[serde(rename = "gift")]
    Gift,
    #[serde(rename = "charitable_donation")]
    CharitableDonation,
    #[serde(rename = "medical_treatment")]
    MedicalTreatment,
    #[serde(rename = "maintenance_expenses")]
    MaintenanceExpenses,
    #[serde(rename = "travel")]
    Travel,
    #[serde(rename = "hotel_accommodation")]
    HotelAccommodation,
    #[serde(rename = "small_value_remittance")]
    SmallValueRemittance,
    #[serde(rename = "liberalized_remittance")]
    LiberalizedRemittance,
    ...
    TaxPayment,
    #[serde(rename = "construction_expenses")]
    ConstructionExpenses,
    #[serde(rename = "advertising_expenses")]
    AdvertisingExpenses,
    #[serde(rename = "advisory_fees")]
    AdvisoryFees,
    ...
    DeliveryFees,
    #[serde(rename = "service_charges")]
    ServiceCharges,
    #[serde(rename = "office_expenses")]
    OfficeExpenses,
    #[serde(rename = "property_purchase")]
    PropertyPurchase,
    #[serde(rename = "property_rental")]
    PropertyRental,
    #[serde(rename = "royalty_fees")]
    RoyaltyFees,
    #[serde(rename = "shares_investment")]
    SharesInvestment,
    #[serde(rename = "fund_investment")]
    FundInvestment,
    #[serde(rename = "bill_payment")]
    BillPayment,
    #[serde(rename = "transportation_fees")]
    TransportationFees,
    #[serde(rename = "salary_payment")]
    SalaryPayment,
    #[serde(rename = "reward_payment")]
    RewardPayment,
    #[serde(rename = "influencer_payment")]
    InfluencerPayment,
...
impl Default for PurposeOfTransaction {
    fn default() -> PurposeOfTransaction {
        Self::ComputerServices
    }
}
