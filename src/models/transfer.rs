...
pub struct Transfer {
    ...
    #[serde(rename = "bank_guid", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub bank_guid: Option<Option<String>>,
    ...
    #[serde(rename = "quote_guid", skip_serializing_if = "Option::is_none")]
    pub quote_guid: Option<String>,
    ...
    pub return_code: Option<Option<String>>,
    ...
    #[serde(rename = "estimated_amount", skip_serializing_if = "Option::is_none")]
    pub estimated_amount: Option<i32>,
    ...
    pub fee_details: Option<Vec<models::FeeDetail>>,
    /// The estimated network fee in base units of network_fee_asset. Only present on `crypto` transfers.
    #[serde(rename = "estimated_network_fee", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub estimated_network_fee: Option<Option<i32>>,
    ...
    #[serde(rename = "network_fee", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub network_fee: Option<Option<i32>>,
    /// The asset code of the network fee. Only present on `crypto` transfers that have successfully completed.
    #[serde(rename = "network_fee_asset", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub network_fee_asset: Option<Option<String>>,
    ...
    #[serde(rename = "network_fee_liability_amount", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub network_fee_liability_amount: Option<Option<i32>>,
    ...
    #[serde(rename = "network_fee_liability_amount_asset", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub network_fee_liability_amount_asset: Option<Option<String>>,
    /// The hash of the blockchain transaction (deprecated: use identifiers array)
    #[serde(rename = "txn_hash", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub identifiers: Option<Vec<models::TransferIdentifiersInner>>,
    /// The guid of the related transfer. Only present on return type transfers.
    #[serde(rename = "reference_transfer_guid", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub reference_transfer_guid: Option<Option<String>>,
    #[serde(rename = "source_account", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub source_account: Option<Option<Box<models::TransferSourceAccount>>>,
    /// The participants in the source account.
    #[serde(rename = "source_participants", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub source_participants: Option<Option<Vec<models::TransferParticipant>>>,
    #[serde(rename = "destination_account", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub destination_account: Option<Option<Box<models::TransferDestinationAccount>>>,
    /// The participants in the source account.
    #[serde(rename = "destination_participants", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub destination_participants: Option<Option<Vec<models::TransferParticipant>>>,
    /// The guid of the deposit address. Only present on crypto deposits.
    #[serde(rename = "deposit_address_guid", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub deposit_address_guid: Option<Option<String>>,
    ...
    #[serde(rename = "hold_details", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub hold_details: Option<Option<Box<models::TransferHoldDetails>>>,
    /// The raw details on the transfer from the bank.
    #[serde(rename = "transfer_details", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub transfer_details: Option<Option<serde_json::Value>>,
    /// The rail the payment was done on. One of: ach, eft, wire, rtp, etransfer
    #[serde(rename = "payment_rail", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub payment_rail: Option<Option<String>>,
    ...
    pub entries: Option<Option<Vec<models::TransferEntry>>>,
}
...
impl Transfer {
    pub fn new() -> Transfer {
        Transfer {
            ...
            network_fee_liability_amount: None,
            network_fee_liability_amount_asset: None,
            txn_hash: None,
            identifiers: None,
            reference_transfer_guid: None,
            source_account: None,
            source_participants: None,
            destination_account: None,
            destination_participants: None,
            deposit_address_guid: None,
            created_at: None,
            updated_at: None,
            hold_details: None,
